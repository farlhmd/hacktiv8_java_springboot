    ...
    4. Latihan4.java
    ~ Dibutuhkan input Tahun oleh user.
    ~ Program ini akan melakukan pengecekan tahun apakah tahun tersebut habis jika di bagi 4
    ~ Jika tahun habis dibagi 4, maka tahun tersebut merupakan kabisat.
